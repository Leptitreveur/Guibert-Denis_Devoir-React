...
export const ContactCardBox = ({ contactData, showIcon = false, toMap = false }) => {
    ...
    const mapLink = (address1 && address2 && toMap) ? `https://www.google.com/maps?q=${encodeURIComponent(address1 + "" + address2)}`: "/contactForm#map";

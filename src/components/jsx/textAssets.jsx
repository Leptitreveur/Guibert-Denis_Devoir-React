...
export function CreditText() {
  const text = [
    ...
    <>
      ...
      sur le site{" "}
      <a href="https:pixabay.com/fr/" rel="noreferrer" target="_blank">
        Pixabay
      </a>
    </>,
    <>
      La favicon de ce site a été fournie par{" "}
      <a href="https:www.flaticon.com/de/kostenlose-icons/john-doe" rel="noreferrer" target="_blank">
        Jhon Doe icons erstellt von Freepik - Flaticon{" "}
      </a>
      et la conversion des images sur{" "}
      <a href="{https:favicon.io/favicon-converter/}" rel="noreferrer" target="_blank">
        {" "} favicon.io
      </a>
      .
    </>,
